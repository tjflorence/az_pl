function entered_stack_data = add_img_to_behav(bdir, bfile, idir, syncdir)

[frame_4d, frame_MIP, img_frame_id, tstamp, entered_stack_data] = parse_azPL_imgfile_gpu(syncdir, idir, bdir);
