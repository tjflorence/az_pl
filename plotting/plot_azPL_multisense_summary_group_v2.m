function plot_azPL_multisense_summary_group_v2(expdir)
...
plot_collections(1).conditions = [1 4 7 10 13];

plot_collections(2).name = 'refVIZ_testHEAT';
plot_collections(2).conditions = [2 5 8 11 14];

plot_collections(3).name = 'refVIZ_testCOOL';
plot_collections(3).conditions = [3 6 9 12 15];

plot_collections(4).name = 'refNOHEAT_testVIZ';
plot_collections(4).conditions = [16 17 18 19 20];

plot_collections(5).name = 'refHEAT_testVIZ';
plot_collections(5).conditions = [21 22 23 24 25];

plot_collections(6).name = 'refCOOL_testVIZ';
plot_collections(6).conditions = [26 27 28 29 30];
...
for collection_num = 1:length(plot_collections);
    ...
    for ii = 1:length(plot_collections(collection_num).conditions)
        ...
        y_vals = y_vals-mean(y_vals(500:1000));
