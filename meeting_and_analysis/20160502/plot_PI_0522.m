...
hcl(1).path = '/Volumes/Untitled/2016-04-25/20160425122134_HC-Gal4x2b_az_PL';
hcl(2).path = '/Volumes/Untitled/2016-04-25/20160425142238_HC-Gal4x2b_az_PL';
hcl(3).path = '/Volumes/Untitled/2016-04-25/20160425165827_HC-Gal4x2b_az_PL';
hcl(4).path = '/Volumes/Untitled/2016-05-02/20160502155938_HC-Gal4x2b_az_PL';
...
for ii = 1:length(cl)
    ...
    cl_vals(ii,1) = summary_data.fix_Idx(1);
    cl_vals(ii,2) = summary_data.fix_Idx(2);
...
for ii = 1:length(hcl)
    ...
    hcl_vals(ii,1) = summary_data.fix_Idx(1);
    hcl_vals(ii,2) = summary_data.fix_Idx(2);
...
for ii = 1:length(ucl)
    ...
    ucl_vals(ii,1) = summary_data.fix_Idx(1);
    ucl_vals(ii,2) = summary_data.fix_Idx(2);
...
prettyprint(f1,'pi_summary_0522')
