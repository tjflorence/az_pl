...
plot_collections(1).name = 'refVIZ_testALLTHERM';
plot_collections(1).conditions_v2 = [10 11 12];

plot_collections(2).name = 'refTHERM_testALLVIZ';
plot_collections(2).conditions_v2 = [ 19 14 29];
...
for collection_num = 1:length(plot_collections);
    ...
    fig_name = ['multiexp_OL_only_group_' plot_collections(collection_num).name];
