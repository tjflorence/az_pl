...
plot_collections(1).conditions_v2 = [13 14 15];

plot_collections(2).name = 'refTHERM_testALLVIZ';
plot_collections(2).conditions_v2 = [20 15 30];
...
for collection_num = 1:length(plot_collections);
    ...
    fig_name = ['multiexp_CL_only_group_' plot_collections(collection_num).name];
