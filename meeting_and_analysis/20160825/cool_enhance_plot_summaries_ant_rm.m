...
hot_blind(1).path = '\\reiser_nas\tj\az_pl\processed\20160818094241_11f03-ant_rm_OL_stim';
hot_blind(1).roi = 2;
hot_blind(1).ver = 2;

hot_blind(2).path = '\\reiser_nas\tj\az_pl\processed\20160818164858_11f03-ant_rm_OL_stim';
hot_blind(2).roi = 3;
hot_blind(2).ver = 2;
...
for collection_num = 1:length(plot_collections);
    ...
    fig_name = ['multiexp_ant_rm_summary_group_' plot_collections(collection_num).name];
