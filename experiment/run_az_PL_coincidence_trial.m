function expi = run_az_PL_coincidence_trial(expi, app)
...
elseif expr.c_trial.data.count < (expr.c_trial.fix_frames + expr.c_trial.dark_frames)
    ...
    switch expr.c_trial.viz_name
        ...
        case 'dynamicOff'
            if expr.c_trial.ref_light_vec(expr.c_trial.data.xpos(expr.c_trial.data.count)) ...
                    < expr.c_trial.light_power
