function expi = run_doubletrench_chr_probe_trial(expi, app)
...
appr.ao.outputSingleScan([5 5 0 1 1 1 1])
%appr.ao.outputSingleScan([5 5 0 0 1 1 1])


%set camera for rear acquisition
if expr.camera.do_capture == 1
    expr.camera.vidObj.setVideoFile([expr.settings.fullpath '\' expr.c_trial.name '_mov']);
    expr.camera.vidObj.startCapture(); % starts camera
end
...
% turn off arena
appr.ao.outputSingleScan([5 0 0 1 1 0 0])
%appr.ao.outputSingleScan([5 0 0 0 1 0 0])
